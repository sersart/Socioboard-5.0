...
class MailService extends MailBase {
    constructor(mailServiceConfig) {
        ...
        this.template = {
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="left" style="background: #fff; margin: 0; margin:0; font-family: Open sans, Arial, Helvetica, sans-serif; font-size: 17px; color: #383737; line-height: 24px;mso-line-height-rule: exactly; text-align: left; padding: 0 5px; padding-bottom:0px; " align="left">
                                                                                        <span>We are excited to have to get started. First, you need to confirm your account. Just press the button below and you're ready to gain all the access to Social Media Board.</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td width="100%" height="30">&nbsp;</td>
            ...
            //  Replace -[Email] [AccountType]  
            loginReminderNotification: '<!DOCTYPE html PUBLIC><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><meta name="format-detection" content="telephone=no" /><title>Account Expiry - SocialMediaBoard</title><link rel="stylesheet" href="email.css" /><style>body {font-family: "Source Sans Pro","Helvetica Neue",Helvetica,Arial,sans-serif;}</style></head><body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0"><center style="background-color:#E1E1E1;"><table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;"><tr><td align="center" valign="top" id="bodyCell"><table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="700" id="emailBody"><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#fff"><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer"><tr><td align="center" valign="top" width="500" class="flexibleContainerCell"><table border="0" cellpadding="30" cellspacing="0" width="100%"><tr><td align="center" valign="top" class="textContent"><center><img src="http://imgur.com/nvNPyAp.png" /></center></td></tr></table></td></tr></table></td></tr></table></td></tr><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffaa7b"><tr style="padding-top:0;"><td align="center" valign="top"><table border="0" cellpadding="30" cellspacing="0" width="700" class="flexibleContainer"><tr><td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell"><table border="0" cellpadding="0" cellspacing="0" width="90%" style="margin-top:10%;"><tr><td align="left"><p>Hi [FirstName],</p></td></tr><tr><td align="left"><p style="margin-top: 7%;">You have not logged in to your SocialMediaBoard account since [LastLogin].We miss you. </p></td></tr><tr><td align="left"><p style="margin-top: 2%;"> Please login to SocialMediaBoard account by <a href="https://www.social-media-board.com/#" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#2979ff;">clicking here</span></a><tr><td align="left"><p style="margin-top: 5%;">Please feel free to contact us in case you have any questions</p></td></tr><tr><td align="left"><p style="margin-top: 10%; margin-bottom:5%;">Best regards<br/>Support Team<br/>SocialMediaBoard</p></td></tr></table></td></tr></table></td></tr></table></td></tr></table><table bgcolor="#E1E1E1" border="0" cellpadding="0" cellspacing="0" width="500" id="emailFooter"><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td align="center" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer"><tr><td align="center" valign="top" width="500" class="flexibleContainerCell"><table border="0" cellpadding="30" cellspacing="0" width="100%"><tr><td valign="top" bgcolor="#E1E1E1"><div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;"><div>Copyright &copy; 2019 <a href="#" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Social Media Board</span></a>. All&nbsp;rights&nbsp;reserved.</div><div>If you do not want to recieve emails from us, you can <a href="https://www.social-media-board.com/Home#/profilesettings" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">unsubscribe</span></a>.</div></div></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td></tr></table></center></body></html>',
       ...
       return new Promise((resolve, reject) => {
        ...
        switch (scheduleObject.moduleId) {
            case 1:
              ...
              emailTitle = 'SocialMediaBoard plan will expire in few days!';
              break;
            case 2:
              emailContent = this.template.expirednotification;
              emailTitle = 'SocialMediaBoard plan expired!';
              break;
            case 3:
              emailContent = this.template.loginReminderNotification;
              emailTitle = 'SocialMediaBoard login reminder!';
              break;
            case 4:
              emailContent = scheduleObject.newsletterContent;
              emailTitle = 'SocialMediaBoard offer only for you!';
              break;
            default:
              break;
          }
