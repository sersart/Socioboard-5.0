...
const user = {
  username: 'testSearchSocialAccounts',
  email: 'testSearchSocialAccounts@testtest.com',
...
describe('Search social accounts', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .post(SEARCH_SOCIAL_ACCOUNTS)
